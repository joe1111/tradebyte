<?php
namespace ElasticExporttradebyteDE\Helper;
        ...
        if(!array_key_exists($variation['data']['item']['id'], $this->itemPropertyCache))
        {
            ...
            foreach($variation['data']['properties'] as $property)
            {
                    ...
                    $property['property']['valueType'] != 'file')
                {
                    ...
                    {
                        $this->getLogger(__METHOD__)->debug('ElasticExporttradebyteDE::item.variationPropertyNotAdded', [
            ...
            $this->getLogger(__METHOD__)->debug('ElasticExporttradebyteDE::item.variationPropertyList', [
                'ItemId'        => $variation['data']['item']['id'],
                'VariationId'   => $variation['id'],
